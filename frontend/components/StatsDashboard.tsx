...
const metrics: StatsMetric[] = [
  ...
  },
  {
    ...
    detail: {
      ...
      points: [
        { detail: "1/3 NLH, 2h 10m", label: "Game 1", meta: "$0", value: 0 },
        { detail: "1/3 NLH, 1h 35m", label: "Game 2", meta: "$0", value: 0 },
        { detail: "2/5 NLH, 3h 05m", label: "Game 3", meta: "$0", value: 0 },
        { detail: "1/3 NLH, 55m", label: "Game 4", meta: "$0", value: 0 },
        { detail: "2/5 NLH, 2h 40m", label: "Game 5", meta: "$0", value: 0 },
        { detail: "Tournament cash", label: "Game 6", meta: "$0", value: 0 },
      ],
...
const dailySummaries: DailySummary[] = [
  {
    ...
    text: "Heart rate stayed low, poker is reset to zero, and GitHub activity beat your normal pace. Sleep is the main signal to protect tonight.",
  },
  {
    date: "Today, 9:15 AM",
    highlights: [
